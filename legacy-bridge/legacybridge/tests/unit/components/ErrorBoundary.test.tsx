...
describe('ErrorBoundary Component', () => {
  ...
  describe('Development vs Production', () => {
    ...
    it('should expand/collapse stack trace', async () => {
      ...
      // Stack trace should be hidden initially (details is closed)
...
describe('ConversionErrorBoundary Component', () => {
  ...
  it('should allow retry for conversion errors', async () => {
    ...
    // After retry, the error boundary should reset and show the component again
    await waitFor(() => {
      expect(screen.getByText('No error')).toBeInTheDocument();
    });
  });
...
describe('useErrorHandler Hook', () => {
  it('should throw errors and log them', () => {
    ...
    // The hook should throw an error when called
...
describe('Edge Cases', () => {
  ...
  it('should handle multiple simultaneous errors', () => {
    ...
    // Should catch the error and show the error boundary
    expect(screen.getByText('Something went wrong')).toBeInTheDocument();
