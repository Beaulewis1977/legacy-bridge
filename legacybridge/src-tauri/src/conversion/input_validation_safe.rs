...
lazy_static! {
    ...
    static ref CONTROL_WORD_REGEX: Regex = Regex::new(r"^[a-zA-Z][a-zA-Z0-9]*$")
        .expect("Failed to compile control word validation regex");
    
    // Regex for detecting dangerous patterns
    static ref DANGEROUS_PATTERNS: Vec<Regex> = vec![
        Regex::new(r"\\object").expect("Failed to compile \\object detection regex"),
        Regex::new(r"\\objdata").expect("Failed to compile \\objdata detection regex"),
        Regex::new(r"\\objemb").expect("Failed to compile \\objemb detection regex"),
        Regex::new(r"\\objlink").expect("Failed to compile \\objlink detection regex"),
        Regex::new(r"\\objautlink").expect("Failed to compile \\objautlink detection regex"),
        Regex::new(r"\\objsub").expect("Failed to compile \\objsub detection regex"),
        Regex::new(r"\\objpub").expect("Failed to compile \\objpub detection regex"),
        Regex::new(r"\\objicemb").expect("Failed to compile \\objicemb detection regex"),
        Regex::new(r"\\objhtml").expect("Failed to compile \\objhtml detection regex"),
        Regex::new(r"\\objocx").expect("Failed to compile \\objocx detection regex"),
        Regex::new(r"\\result").expect("Failed to compile \\result detection regex"),
        Regex::new(r"\\pict").expect("Failed to compile \\pict detection regex"),
        Regex::new(r"\\field").expect("Failed to compile \\field detection regex"),
        Regex::new(r"\\fldinst").expect("Failed to compile \\fldinst detection regex"),
        Regex::new(r"\\fldrslt").expect("Failed to compile \\fldrslt detection regex"),
        Regex::new(r"\\datafield").expect("Failed to compile \\datafield detection regex"),
        Regex::new(r"\\datastore").expect("Failed to compile \\datastore detection regex"),
        Regex::new(r"\\xe").expect("Failed to compile \\xe detection regex"),
        Regex::new(r"\\tc").expect("Failed to compile \\tc detection regex"),
        Regex::new(r"\\bkmkstart").expect("Failed to compile \\bkmkstart detection regex"),
        Regex::new(r"\\bkmkend").expect("Failed to compile \\bkmkend detection regex"),
        Regex::new(r"\\\*\\generator").expect("Failed to compile \\*\\generator detection regex"),
    ];
    
    // Regex for script detection in Markdown
    static ref SCRIPT_PATTERNS: Vec<Regex> = vec![
        Regex::new(r"(?i)<script[^>]*>").expect("Failed to compile script tag detection regex"),
        Regex::new(r"(?i)javascript:").expect("Failed to compile javascript: URL detection regex"),
        Regex::new(r"(?i)vbscript:").expect("Failed to compile vbscript: URL detection regex"),
        Regex::new(r"(?i)onload\s*=").expect("Failed to compile onload handler detection regex"),
        Regex::new(r"(?i)onerror\s*=").expect("Failed to compile onerror handler detection regex"),
        Regex::new(r"(?i)onclick\s*=").expect("Failed to compile onclick handler detection regex"),
        Regex::new(r"(?i)onmouseover\s*=").expect("Failed to compile onmouseover handler detection regex"),
    ];
}
...
mod tests {
    ...
    fn test_number_validation() {
        ...
        // Valid numbers
        assert_eq!(validator.validate_number(0, "test").expect("should be valid"), 0);
        assert_eq!(validator.validate_number(100, "test").expect("should be valid"), 100);
        assert_eq!(validator.validate_number(-100, "test").expect("should be valid"), -100);
        assert_eq!(validator.validate_number(999999, "test").expect("should be valid"), 999999);
